  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        <ProfileItem label="First Name" value="Michael" />
        <ProfileItem label="Last Name" value="Nguyen" />
        <ProfileItem label="Username" value="obema007" />
        <ProfileItem label="Email" value="obema@example.com" />
