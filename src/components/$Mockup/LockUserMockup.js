...
export default function LockUserMockupWithConfirm() {
    return (
                    ...
                    <div className="border-2 border-black relative">
                        ...
                        <div className="grid grid-cols-5 border-b border-black relative">
                            ...
                            <div className="p-2 flex gap-2 relative">
                                {/* Ban button */}
                                <button className="border-2 border-black px-2 bg-red-200">
                                    Ban
                                </button>
                                <button className="border-2 border-black px-2">View Detail</button>

                                {/* Confirmation Popup */}
                                <div className="absolute -top-16 left-0 border-2 border-black bg-white p-2 w-40 text-center shadow-lg">
                                    <p className="text-sm mb-2">Ban this user?</p>
